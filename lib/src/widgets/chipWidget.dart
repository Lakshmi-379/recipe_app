    ...
    return
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ActionChip(
                label: Text('Popular', style: TextStyle(color: AppColors.greenColor),),
                avatar: CircleAvatar(
              ...
              ActionChip(
                ...
                label: Text(
                  'Break Fast', style: TextStyle(color: AppColors.greenColor),),
                avatar: CircleAvatar(
              ...
              ActionChip(
                shadowColor: Colors.black,
                label: Text('Snacks', style: TextStyle(color: AppColors.greenColor),),
                avatar: CircleAvatar(
              ...
              ActionChip(
                shadowColor: Colors.black,
                label: Text('Salad', style: TextStyle(color: AppColors.greenColor ),),
                avatar: CircleAvatar(
              ...
              ActionChip(
                shadowColor: Colors.black,
                label: Text('Dinner', style: TextStyle(color: AppColors.greenColor),),
                avatar: CircleAvatar(
